...
$play_styles = array('inherit' => __('全体設定に従う', 'gaming-web')) + GW_Settings::play_style_choices();
$audio_fields = array(
    'normal_bgm' => array(
        ...
        <table class="widefat striped gaming-web-stage-table">
            ...
            <tbody>
                <?php foreach ($stages as $post) : ?>
                    ...
                    $play_style = get_post_meta($post_id, '_gaming_web_play_style', true);
                    $play_style = array_key_exists($play_style, $play_styles) ? $play_style : 'inherit';
                    ...
                    >
                        ...
                        <td>
                            ...
                            <div class="gaming-web-admin__inline-fields">
                                ...
                                <label>
                                    <span><?php esc_html_e('Action / アクション', 'gaming-web'); ?></span>
                                    <select name="gaming_web_play_style[<?php echo esc_attr($post_id); ?>]">
                                        <?php foreach ($play_styles as $value => $text) : ?>
                                            <option value="<?php echo esc_attr($value); ?>" <?php selected($play_style, $value); ?>><?php echo esc_html($text); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </label>
                            </div>
