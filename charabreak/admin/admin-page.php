...
$play_style = GW_Settings::get(GW_Settings::OPTION_PLAY_STYLE);
...
$audio_final_bgm_id = absint(GW_Settings::get(GW_Settings::OPTION_AUDIO_FINAL_BGM_ID));
$audio_final_bgm_url = $audio_final_bgm_id ? wp_get_attachment_url($audio_final_bgm_id) : '';
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p>
                            <label for="gaming-web-play-style"><strong><?php esc_html_e('Game Action Style / ゲームアクション', 'gaming-web'); ?></strong></label><br>
                            <select id="gaming-web-play-style" name="<?php echo esc_attr(GW_Settings::OPTION_PLAY_STYLE); ?>">
                        ...
                        <p class="description">
                            <?php esc_html_e('Breakは文字を壊す爽快感、Bloomは文字を花や光に変える満足感、Hybridは通常攻撃で壊し、ため攻撃で咲かせます。ステージ別に上書きできます。', 'gaming-web'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row"><?php esc_html_e('Final Stage BGM / 最終ステージBGM', 'gaming-web'); ?></th>
                    <td>
                        <div class="gaming-web-media-field gaming-web-media-field--audio" data-gw-media-type="audio">
                            <input type="hidden" class="gaming-web-media-field__input" name="<?php echo esc_attr(GW_Settings::OPTION_AUDIO_FINAL_BGM_ID); ?>" value="<?php echo esc_attr($audio_final_bgm_id); ?>">
                            <div class="gaming-web-media-field__preview">
                                <span><?php echo esc_html($audio_final_bgm_url ? basename((string) wp_parse_url($audio_final_bgm_url, PHP_URL_PATH)) : __('標準BGMを使う', 'gaming-web')); ?></span>
                            </div>
                            <button type="button" class="button gaming-web-media-field__choose"><?php esc_html_e('音源を選択', 'gaming-web'); ?></button>
                            <button type="button" class="button-link-delete gaming-web-media-field__clear"><?php esc_html_e('解除', 'gaming-web'); ?></button>
                        </div>
                        <p class="description">
                            <?php esc_html_e('ステージ種別が「最終ステージ」のページで、個別ステージBGMが未設定の場合に使われます。', 'gaming-web'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
